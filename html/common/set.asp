<%
	...
	ElseIf InStr(LCase(strPageUrl),"/ez/") > 0 Then 
		...
		If LCase(Request.Cookies("CMSTBCODE")) = "intro08" Then
			strMenu1 = "sub6"
			Response.Cookies("strMenu1") = strMenu1
			strLastShortFileName = "04"	
			
		ElseIf LCase(Request.Cookies("CMSTBCODE")) = "koi05" Then
			strMenu1 = "sub6"
			Response.Cookies("strMenu1") = strMenu1
			strLastShortFileName = "03"

		ElseIf InStr(LCase(Request.Cookies("CMSTBCODE")),"org01") > 0 Then
			strMenu1 = "sub6"
			Response.Cookies("strMenu1") = strMenu1
			strLastShortFileName = "06"

		ElseIf InStr(LCase(Request.Cookies("CMSTBCODE")),"intro") > 0 Then
			strMenu1 = "sub1"
		...
		Else
			...
			Case "sch05":
				strMenu1 = "sub6" 'chungnyun
				Response.Cookies("strMenu1") = "sub6"
				strLastShortFileName = "05"	
				strLastShortSubFileName = ""

			Case "koi01":
				strMenu1 = "sub7" 'Notice
				Response.Cookies("strMenu1") = "sub7"
				strLastShortFileName = "01"	
				strLastShortSubFileName = ""
