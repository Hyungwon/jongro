...
<table width="1080" height="29" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="320" align="left">
    	<a href="http://www.jongro.org/html/cafe/banner.html" target="_blank" onMouseOver="MM_swapImage('cafe','','../../images/common/top/cafe_on.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="../../images/common/top/cafe_off.jpg" name="cafe" width="156" height="29" border="0"></a>
    </td>
    <td width="760" align="right"><table width="328" border="0" cellspacing="0" cellpadding="0">
      <tr>
